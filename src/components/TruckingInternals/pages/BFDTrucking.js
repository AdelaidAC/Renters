...
const services = [
    ...
    {
        service: 'Non-Sufficient Funds on ', 
        fee: ''
    },
    {
        service: 'DOT, ICC, MCP:', 
    ...
    {
        service: 'Credit Card/Check:', 
        fee: '$35.00'
    }, 
]

export default function BFDTrucking({firstSignature, secondSignature, name, initials, address, phone}) {
    return (
        <div className='sheet font-11'>
            <Logo />
            <div className="d-flex justify-content-between">
                <label>Client Name:<Input /></label>
                <label>Date: <CDate/></label>
            </div>
            <Title text="STANDARD BROKER FEE DISCLOSURE" />
            <strong><p className='text-center text-bold mb-0'>This disclosure was prepared by California Insurance Commissioner: READ IT CAREFULLY!</p></strong>
            <p>
            ...
            <p className='mb-1'>Client Name:<Input /></p>
            <Title text="Appointment of Insurance Broker and Agreement to Pay Broker Fee" />
            <p>As of today, the undersigned ("Client") appoints Adriana's Insurance Service, Inc. ("Broker") as his/her insurance broker of record. This Agreement shall continue in
                ...
                insurance if premiums or fees remain unpaid to Broker.</p>
            <p>CLIENT agrees to pay BROKER a broker fee for BROKER’S services. The Broker Fee is <Input /> (Client Initials: <Input />). Client understands
                ...
                Additional Services: Broker may charge the following fees for the following services in addition to the broker fee:</p>
            ...
            <p><strong>PREMIUM PAYMENTS:</strong> Broker may, at its sole option, accept premium installment payments and transmit the payments to the insurer for an additional fee of
                ...
                amount of the premium payment.</p>
            <Title text="CANCELLATION AND OTHER MISCELLANEOUS PROVISIONS" />
            <p className="mb-1">Broker will only honor cancellation requests made in writing and signed by the Client. Broker may provide client with insurance identification cards upon completion
                ...
                rules set up by the DR, in accordance with California Code of Civil Procedure, without right of appeal.</p>
            <Signature firstSignature={firstSignature} secondSignature={secondSignature}/>
            <label className='mt-1 text-center'><strong>If you have any questions or complaints please call our customer service toll free number at 1-888-290-4040. In any case of questions/problems concerning broker fees or insurance,
                contact the Department of Insurance at 1-800-927-HELP</strong></label>
        </div>
    )
}