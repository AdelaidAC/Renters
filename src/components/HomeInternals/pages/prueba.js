...
export default function Prueba({firstSignature, secondSignature}) {
    ...
    let words = toWords.convert(452.36, { currency: true });
    ...
    return (
        <div className='sheet font-14 text-justify'>
            ...
            <div className='d-flex justify-content-between mt-5 pt-5 mx-5 text-center'>
