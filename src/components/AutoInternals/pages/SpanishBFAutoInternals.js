...
export default function SpanishBFAutoInternals({name}) {
    ...
    return (
        <div className='sheet font-9 text-justify'>
            ...
            <p className='lh-1'>
                El honorario del <b>Broker es</b> <Input width="100px" maxlength="15"/>. El cliente está de acuerdo en pagar esta cuota y entiende que los honorarios <b>SON/NO SON reembolsables</b> (circule uno) independientemente de que la póliza sea cancelada o rechazada por el cliente o la aseguradora. El cliente
